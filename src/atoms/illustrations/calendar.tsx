...
export const Calendar: React.FC<Props> = ({ width = 152, height = 152 }) => (
  <svg width={width} height={height} viewBox="0 0 152 152" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="51.0444" y="60.2334" width="11.4111" height="11.4111" rx="2" fill="#3040D6" fillOpacity="0.2" />
    ...
    <rect x="51.0444" y="83.9336" width="11.4111" height="11.4111" rx="2" fill="#3040D6" fillOpacity="0.2" />
