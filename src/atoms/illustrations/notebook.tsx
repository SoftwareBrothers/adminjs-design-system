...
export const Notebook: React.FC<Props> = (props) => {
  const { width, height } = props
  const svgWidth = width || '152'
  const svgHeight = height || '152'
  return (
    <svg width={svgWidth} height={svgHeight} viewBox="0 0 152 152" fill="none" xmlns="http://www.w3.org/2000/svg">
