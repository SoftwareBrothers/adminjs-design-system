    ...
    <DropDown>
      <DropDownTrigger>
        <LoggedUserInfo pr="xl">
          <Box mr="default">
            <Text fontSize="default" lineHeight={title ? 'lg' : 'xl'} fontWeight="normal">
              {email}
            </Text>
            <Text fontSize="sm" color="grey40" lineHeight="sm">
              {title}
            </Text>
          </Box>
      ...
      <DropDownMenu top={height}>{children}</DropDownMenu>
    </DropDown>
  )
}
